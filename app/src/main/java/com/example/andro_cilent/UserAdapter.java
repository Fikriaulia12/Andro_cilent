...
public class UserAdapter extends
    ...
    private List<com.example.andro_cilent.User> userList;

    public UserAdapter(List<com.example.andro_cilent.User> userList) {
    ...
    {
        com.example.andro_cilent.User user = userList.get(position);
