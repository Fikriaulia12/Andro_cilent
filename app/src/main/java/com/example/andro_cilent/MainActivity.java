package com.example.andro_cilent;
...
import com.example.andro_cilent.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    private List<com.example.andro_cilent.User> userList = new ArrayList<>();
    ...
    private void addUser(String name, String email, String prodi, String fakultas) {
        com.example.andro_cilent.ApiService apiService = com.example.client_user.ApiClient.getClient().create(com.example.andro_cilent.ApiService.class);
        com.example.andro_cilent.User user = new com.example.andro_cilent.User(name, email, prodi, fakultas);
